...
group = "com.hivemq"
description = "SDK for the development of HiveMQ Enterprise Security Extension customizations"

metadata {
    readableName = "HiveMQ Enterprise Security Extension Customization SDK"
    organization {
        name = "HiveMQ GmbH"
